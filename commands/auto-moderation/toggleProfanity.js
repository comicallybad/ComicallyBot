...
module.exports = {
    ...
    aliases: ["profanitytoggle"],
    category: "auto-moderation",
    description: "Toggles the server custom profanity filter on or off.",
    ...
    run: (client, message, args) => {
        ...
        s(logChannel, '', embed);
        return r(message.channel, message.author, `The profanity filter has been toggled to ${args[0]}.`).then(m => del(m, 7500));
    }
}