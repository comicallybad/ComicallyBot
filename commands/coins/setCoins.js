...
module.exports = {
    ...
    run: (client, message, args) => {
        ...
        if (isNaN(args[1]) || parseInt(args[1]) < 0)
            return message.reply("Please provide a valid amount greater than or equal to 0.").then(m => m.delete({ timeout: 7500 }));
        ...
        function setCoins(userID, coinsToSet) {
            ...
            coins.updateOne({ guildID: guildID, userID: userID }, {
                ...
                **> Coins Set to:** ${coinsToSet}`);
                ...
                return message.reply("User was set to: " + coinsToSet + " coins").then(m => m.delete({ timeout: 7500 }));
