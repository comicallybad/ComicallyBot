...
module.exports = {
    name: "getmemberroles",
    aliases: ["memberroles", "listmemberroles"],
    category: "administration",
    description: "Add permitted role for mod commands",
    permissions: "moderator",
    usage: "<role name|@role>",
    run: (client, message, args) => {
        getCommandStatus(message, "getmemberroles").then(function (res) {
                    ...
                    if (res === true) {
                        ...
                        db.findOne({
                            ...
                            if (!exists) return message.reply("Error within database").then(m => m.delete(7500))
                                ...
                                } else return message.reply("You have no bot member roles set.")
                            }
