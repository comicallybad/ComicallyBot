...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        return s(message.channel, `The current delete reaction has been set to: ${reaction.length <= 17 ? reaction : message.guild.emojis.cache.get(reaction)}`).then(m => del(m, 15000));
    }
}