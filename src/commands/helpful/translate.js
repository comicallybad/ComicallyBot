...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand.setName('to').setDescription('Translates a message to a specified language.')
        ...
        .addSubcommand(subcommand =>
            subcommand.setName('default').setDescription('Translates a message to English.')
                .addStringOption(option => option.setName('message').setDescription('Message to translate').setRequired(true))),
    execute: (interaction) => {
